						...
						<div className='w-full'>
							<div className='flex items-start mt-5 pl-1 w-full'>
								...
								<div className='mb-2 border-b border-primary mr-4 pb-4 pt-2 w-full'>
									<TextareaAutosize
										className='pl-2 w-full h-auto text-lg pb-12 text-gray-700 placeholder:text-gray-600 placeholder:text-lg focus:outline-none resize-none lg:mb-2'
										autoFocus
										autoComplete='true'
									...
									<div className='flex pl-2 items-center space-x-1 text-blue-500'>
										<svg
							...
							<div className='flex pl-2  items-center justify-between'>
								<div className='flex items-center space-x-3.5 ml-14'>
