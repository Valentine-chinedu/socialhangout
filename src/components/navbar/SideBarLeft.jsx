...
const SideBarLeft = () => {
	return (
		<div className='w-[35%] lg:w-[90%] h-full flex flex-col items-center space-y-72 lg:space-y-0'>
			<div className='flex flex-col h-full items-center lg:items-end pt-3 space-y-8 w-full'>
				<div className='flex flex-col items-start space-y-6 lg:pr-[5.5rem]'>
					<div>
						<svg viewBox='0 0 24 24' aria-hidden='true' className='h-7'>
							<g>
								<path
									fill='#428bcf'
					...
					<div className='flex justify-center items-center space-x-4'>
						...
						<h2 className='text-lg hidden lg:flex'>Home</h2>
					</div>

					<div className='flex justify-center items-center space-x-4'>
						<svg viewBox='0 0 24 24' aria-hidden='true' className='h-6'>
							<g>
						...
						<h2 className='text-lg hidden lg:flex'>Explore</h2>
					</div>
					<div className='flex justify-center items-center space-x-4'>
						<svg viewBox='0 0 24 24' aria-hidden='true' className='h-6'>
							<g>
						...
						<h2 className='text-lg hidden lg:flex'>Notifications</h2>
					</div>
					<div className='flex justify-center items-center space-x-4'>
						<svg viewBox='0 0 24 24' aria-hidden='true' className='h-6'>
							<g>
						...
						<h2 className='text-lg hidden lg:flex'>Messages</h2>
					</div>
					<div className='flex justify-center items-center space-x-4'>
						<svg viewBox='0 0 24 24' aria-hidden='true' className='h-6'>
							<g>
						...
						<h2 className='text-lg hidden lg:flex'>Bookmarks</h2>
					</div>
					<div className='flex justify-center items-center space-x-4'>
						<svg viewBox='0 0 24 24' aria-hidden='true' className='h-6'>
							<g>
						...
						<h2 className='text-lg hidden lg:flex'>Lists</h2>
					</div>
					<div className='flex justify-center items-center space-x-4'>
						<svg viewBox='0 0 24 24' aria-hidden='true' className='h-6'>
							<g>
						...
						<h2 className='text-lg hidden lg:flex'>Profile</h2>
					</div>
					<div className='flex justify-center items-center space-x-4'>
						<svg viewBox='0 0 24 24' aria-hidden='true' className='h-6'>
							<g>
						...
						<h2 className='text-lg hidden lg:flex'>More</h2>
					</div>
				</div>
