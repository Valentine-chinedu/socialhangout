...
const Navbar = () => {
	...
	return (
		<div
			className={`flex flex-col h-full fixed overflow-x-hidden transition-width duration-700 ease-out left-0 top-0 lg:items-center bg-secondary lg:bg-primary lg:mt-20 lg:space-y-40 lg:mr-2 lg:z-40 z-50 lg:w-[34%] lg:overflow-visible lg:relative lg:transition-none ${
